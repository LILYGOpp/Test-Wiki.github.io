...
<table role="table" class="center_table">
    ...
    <tr>
        <td>网络模型</td>
        <td><ul><li>支持YOLOv3</li><li>Mobilenetv2</li><li>TinyYOLOv2</li><li>人脸识别等</li></ul></td>
    </tr>
    <tr>
        <td>深度学习框架</td>
    ...
    <tr>
        <td>视频处理</td>
        <td><ul><li>神经网络处理器(KPU)</li><li>FPU满足IEEE754-2008标准</li><li>音频处理器(APU)</li><li>快速傅里叶变换加速器(FFT)</li></ul></td>
    </tr>
  </tbody>
</table>
